...
import { RatingBadge, SessionTypeBadge } from "@/components/badges";
  ...
  useEffect(() => {
    async function fetchProgress() {
      ...
      try {
        ...
        if (!res.ok) {
          throw new Error("حدث خطأ أثناء تحميل خريطة التقدم");
        }
                    ...
                    >
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex gap-1">
                          <SessionTypeBadge value={sess.session_type as any} />
                          <RatingBadge value={sess.rating} />
                        </div>
                      </div>
